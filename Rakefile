...
desc 'Generate documentation for the consignment extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ConsignmentExtension'
...
desc 'Test the consignment extension.'
...
namespace :test do
  desc 'Functional test the consignment extension.'
  ...
  desc 'Unit test the consignment extension.'
